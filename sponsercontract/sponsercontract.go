...
type SponserContract struct {
	ContractID   string `json:"contractID"`
	ContractFile string `json:"contractFile"`
	ContractType string `json:"contractType"`
	SponsorsName string `json:"sponsorsName"`
...
type SponserContractChaincode struct {
	contractapi.Contract
}

func (cc *SponserContractChaincode) InitLedger(ctx contractapi.TransactionContextInterface) error {
	// Initialize any initial data if required
	fmt.Println("sponser contract Deploy Successfully")
	return nil
}

// CreateContract creates a new contract
func (cc *SponserContractChaincode) AddSponserContract(ctx contractapi.TransactionContextInterface, contractID string, contractDetailsJSON string) error {
	...
	contractDetails := &SponserContract{}
...
func (cc *SponserContractChaincode) ApproveSponserContract(ctx contractapi.TransactionContextInterface, contractID string, status string, actionBy string, actionDate string, comment string) error {
...
func (s *SponserContractChaincode) GetAllContract(ctx contractapi.TransactionContextInterface) ([]*SponserContract, error) {
...
func main() {
	chaincode, err := contractapi.NewChaincode(&SponserContractChaincode{})
	if err != nil {
